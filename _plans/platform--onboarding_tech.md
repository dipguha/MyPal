...
- [ ] **HMG group membership for added Admins** is not handled by onboarding (left to `platform--access-control`). Confirm whether an Admin invited during onboarding should join the HMG group immediately. — *owner: access-control author*
